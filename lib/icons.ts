...
export type IconName = 'flash' | 'clock-01' | 'moon' | 'inbox' | 'checkmark-circle-02' | 'dumbbell-01' | 'restaurant-02' | 'repeat' | 'briefcase-01' | 'stethoscope' | 'moon-02' | 'yoga-01' | 'user-multiple' | 'wallet-01' | 'chart-line-data-01' | 'mortarboard-02' | 'tree-01' | 'task-01' | 'file-01' | 'game-controller-01' | 'bulb' | 'rocket-01' | 'folder-01' | 'home-01' | 'laptop' | 'camera-01' | 'paint-board' | 'book-open-01' | 'airplane-01' | 'favourite' | 'star' | 'money-bag-01' | 'plant-01' | 'music-note-01' | 'shopping-cart-01' | 'user-group' | 'target-01' | 'comment-01' | 'delete-02' | 'calendar-add-01' | 'google' | 'logout-03' | 'cloud-off' | 'arrow-up-right-01' | 'add-01' | 'more-horizontal' | 'download-04' | 'edit-02' | 'user-circle' | 'shield-01' | 'note-add' | 'tag-01';
export const ICONS: Record<IconName, { body: string; w: number; h: number }> = {
 ...
 "bulb": {
  "body": "<path fill=\"none\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"1.5\" d=\"M17.292 16a8 8 0 1 0-10.583 0M12 11v5m-3.5 3h7M10 22h4\"/>",
  "w": 24,
  "h": 24
 },
 "rocket-01": {
